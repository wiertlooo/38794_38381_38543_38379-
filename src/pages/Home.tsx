  ...
  return (
    <div className="wrapper">
      ...
      <div className="btn-container">
        <button className="btn btn-breakfast" onClick={handleBreakfastClick}>
          Breakfast
        </button>
      ...
      <div id="recipe-container">
        ...
        <h2>Instruction</h2>
        <p>
          Preheat oven to 220°C. Arrange sausages in a baking dish. Mix milk,
          eggs, and flour to form a batter. Pour over sausages and bake until
          puffed and golden. Preheat oven to 220°C. Arrange sausages in a baking
          dish. Mix milk, eggs, and flour to form a batter. Pour over sausages
          and bake until puffed and golden. Preheat oven to 220°C. Arrange
          sausages in a baking dish. Mix milk, eggs, and flour to form a batter.
          Pour over sausages and bake until puffed and golden.
        </p>
      </div>
    </div>
  );
